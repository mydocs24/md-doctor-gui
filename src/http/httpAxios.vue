<script>
  ...
  mock.onGet('doctor/me').reply(200, {
    name: 'Doctor Aibolit',
  ...
  mock.onGet('doctor/accidents').reply(200, {
    total: 5,
    'per_page': 15,
    'current_page': 1,
    'last_page': 1,
  ...
  mock.onGet('doctor/accidents/17').reply(200, {
    id: 17,
  ...
  mock.onPut('doctor/accidents/17').reply(200, {
    id: 17,
    date: '2017-03-12',
    refNum: 'ref-01-0001',
    city: 'Madrid',
  ...
  mock.onGet('doctor/accidents/17/surveys').reply(200, {
    surveys: [
      {
        id: 1,
        type: 'accident',
  ...
  mock.onGet('doctor/accidents/17/caseType').reply(200, {
    id: 1,
    title: 'Insurance'
  })

  mock.onGet('doctor/accidents/17/services').reply(200, {
    total: 5,
    'per_page': 5,
    'current_page': 1,
    'last_page': 1,
  ...
  mock.onGet('doctor/accidents/17/patient').reply(200, {
    id: 1,
    name: 'Foster Abigail',
    city: 'Barcelona',
  ...
  mock.onGet('doctor/surveys').reply(200, {
    total: 5,
    'per_page': 5,
    'current_page': 1,
    'last_page': 1,
  ...
  mock.onGet('doctor/services').reply(200, {
    total: 5,
    'per_page': 5,
    'current_page': 1,
    'last_page': 1,
  ...
  mock.onGet('doctor/accidents/17/status').reply(200, {
    status: 'new'
  })
  ...
  mock.onGet('doctor/caseTypes').reply(200, {
    data: [
      {
        id: 1,
        title: 'Insurance'
